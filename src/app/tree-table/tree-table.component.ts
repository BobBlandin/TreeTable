...
export class TreeTableComponent implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit(): void {
    this.initScrollFrozen();
  }

  /**
   * It listens for a wheel event on the frozen body, and if the scrollable area can scroll, it scrolls the scrollable area instead of the frozen body
