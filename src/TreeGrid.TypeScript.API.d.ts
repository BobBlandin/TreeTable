...
interface TTGrid {
   ...
   ChangeImg(row: TRow, col: string, idx: number, val: number[], assign?: boolean|number, refresh?: boolean|number, undo?: boolean|number): any;
...
interface TGridsApi {
   ...
   OnAssignImage(grid: TGrid, row: TRow, col: string, oldrow: TRow, oldcol: string, image: any): boolean|number|null|undefined|void;
   ...
   OnGetExportValue(grid: TGrid, row: TRow, col: string, str: string, format: string): string|null|undefined|void;
   ...
   OnGetGanttFlagText(grid: TGrid, row: TRow, col: string, index: number, text: string, exp: boolean|number): string|null|undefined|void;
   ...
   OnGetGanttHtml(grid: TGrid, row: TRow, col: string, width: number, comp: number, crit: number, plan: number, index: number, txt: string, left: number, maxwidth: number, cls: string[], exp: boolean|number): string|null|undefined|void;
   ...
   OnGetGanttRunContainer(grid: TGrid, row: TRow, col: string, run: any, id: string, Rect: number[], classArg: string, first: number, last: number, type: number, text: string): any|null|undefined|void;
   OnGetGanttRunRect(grid: TGrid, row: TRow, col: string, run: any, index: number, Rect: number[], type: number): null|undefined|void;
   OnGetGanttRunSideRect(grid: TGrid, row: TRow, col: string, run: any, index: number, Pos: number[], Rect: number[], side: number, exp: boolean|number): null|undefined|void;
   OnGetGanttRunSideText(grid: TGrid, row: TRow, col: string, run: any, index: number, text: string, width: number, side: number, rect: number[], exp: boolean|number): string|null|undefined|void;
   OnGetGanttRunText(grid: TGrid, row: TRow, col: string, run: any, index: number, text: string, width: number, left: number, maxwidth: number, cls: string[], exp: boolean|number): string|null|undefined|void;
   OnGetGanttSideHtml(grid: TGrid, row: TRow, col: string, width: number, comp: number, crit: number, plan: number, index: number, txt: string, side: number, exp: boolean|number): string|null|undefined|void;
   ...
   OnOpenImage(grid: TGrid, row: TRow, col: string, images: any, replace: boolean|number, drop: boolean|number): boolean|number|null|undefined|void;
   ...
   OnSelect(grid: TGrid, row: TRow, deselect: boolean|number, Cols: string[], test: boolean|number): boolean|number|null|undefined|void;
   OnSelectAll(grid: TGrid, select: number, type: number, test: boolean|number): boolean|number|null|undefined|void;
   ...
   OnSelected(grid: TGrid, row: TRow, deselect: boolean|number, Cols: string[]): boolean|number|null|undefined|void;
   ...
   OnShowNested(master: TGrid, row: TRow, detail: any, cell: any, id: string): boolean|number|null|undefined|void;
   ...
   OnStartDrag(grid: TGrid, row: TRow, col: string, more: boolean|number, copy: boolean|number, rows: TRow[]): boolean|number|null|undefined|void;
